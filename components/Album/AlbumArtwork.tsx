    ...
    >
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="text-center w-full max-w-sm px-6">
          ...
          <div className="flex items-center justify-center gap-4 py-2 px-6 rounded-full bg-white/[0.02] border border-white/5 backdrop-blur-[40px] inline-flex mx-auto saturate-[180%]">
